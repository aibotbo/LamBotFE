...
type BotTradeMethodResultCanvasProps = {
  results: boolean[];
};

const BotTradeMethodResultCanvas: FC<BotTradeMethodResultCanvasProps> = ({ results }) => {
...
export default BotTradeMethodResultCanvas;
